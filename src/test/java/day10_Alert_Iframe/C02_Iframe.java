...
public class C02_Iframe extends TestBase {
    ...
    public void iframe(){
       ...
       String actualTest= driver.findElement(By.xpath("//p[text()='An iframe with a thin black border:']")).getText();
        Assert.assertTrue(actualTest.contains("black border"));


        /*
        Eger iki tane iframe olsaydi ve 2. fram'e gecmek isteseydim index'i 1 almamiz gerekecekti.
         */
        ...
        String actuelText02 = driver.findElement(By.xpath("//*[text()='Applications lists']")).getText();
        Assert.assertEquals(actuelText02, "Applications lists");


        //➢ Son olarak footer daki ‘Povered By’ yazisini varligini test edilip
        //burayi yapabilmen icin once icine girdigin "iframe" den cikman gerekiyor
        //bunun icinde
        //fakat bir iframe ye girdin, sonra bir iframe ye daha girersen "parent" yerine
        //"defaultContent" kullanabilirsin(bu ikisini karistirmis olabilirim slayta bak)
