...
//        5-ismi "en sevdigim cookie" ve degeri "cikolatali" olan bir cookie  olusturun(new )  ve sayfaya ekleyin
        Cookie yeniCookie = new Cookie("en sevdigim cookie", "cikolatali");
        driver.manage().addCookie(yeniCookie);
        System.out.println(driver.manage().getCookies().size());

//        6-eklediginiz cookie'nin sayfaya eklendigini test edin
        //NOTE: ESKI COOKIES SIZE ILE YENI COOKIES SIZE INI KARSILASTIRIRSAK BOYLECE ARTIP ARTMADIGINI ANLARIZ
...
//        7-ismi skin olan cookie'yi silin ve silindigini test edin
        ...
        /*
        2.YOL
        assertFalse(allCookies.contains("skin"));
