...
public class C02_Log4jTest extends TestBase {
    ...
    //!!logger imort ederken, "apache" den import etmeye dikkat et
    //Main in icinde "Resources" kisminda bir dosay olusturduk, onun bir kismina
    //"INFO", "DEBUG" veya "ALL" yazisimiza gore bize verileri getirecek
